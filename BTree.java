...
//	}
	...
	public void insert(T key, String value){
		if (isEmpty()) {
			...
			if (!ln.insert(new DictionaryPair(key, value))) {
				...
				ln.dictionary.set(ln.numPairs, new DictionaryPair(key, value));
				ln.numPairs++;
				sortDictionary(ln.dictionary);
				...
				if (ln.parent == null) {
					...
					parent_keys.set(0 , halfDict.get(0).key);
	 ...
	 */
	public ArrayList<String> search(T lowerBound, T upperBound) {
	...
	private class InternalNode extends Node {
		 ...
		 */
		private void removeKey(int index) { this.keys.set(index , null); }
	...
	public class DictionaryPair implements Comparable<DictionaryPair> {
		 ...
		 */
		public DictionaryPair(T key, String value) {
			this.key = key;
			this.value = value;
		}
